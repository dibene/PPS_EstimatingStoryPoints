...
def main():
# load training data:
# sys.argv[1] = proyecto = mesos
# sys.argv[2] = repo = apache
    ...
    # carga el diccionario del repo
    # cambia las palabras del proyecto por el valor del diccionario
