...
if pretrain == 'x':
    ...
    # devuelve los weigth del layer embeding 
...
#  dropout_inp = True , dropout_hid = True

# levanta datos de un proyecto solo 
...
# elige metrica de error mean square error
...
# por defecto entra siempre en la primera
# fixed crea el model_fixed
# el cual prepara los datos con los pesos de embedding a to_features e inicializa la capa LSTM
if 'fixed' in pretrain:
    # multiplicacion de weight por datos injeccion de los pesos de lstm guardados anteriormentes
...
## ATENCION
# entra en else si no se especifica el fixed en pretrain 
# este modelo carga los pesos embedding directamente en la capa Embedding                          
# else:
